...
class test_taxa_summary_file_parse(TestCase):
    ...
    def test_taxa_file(self):
        filtered_sample_ids, taxa_labels, collapsed_taxa_table = \
            ...
            self.metadata_category, self.metadata_value, select_taxa=self.taxa_ids)
        ...
        # Should get the slide of the table corresponding to the matching sample 
        self.assertTrue(array_equal(collapsed_taxa_table, self.table[:,0,None]))
